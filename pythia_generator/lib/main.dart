...
''';
  ...
  File('pythia/lib/generated_files/schedule_supporting_data.dart')
...
$fileString);
''';
      File('pythia/lib/generated_files/$fileName.dart')
  ...
  for (final agData in allAntigenData) {
    fileNames.add(agData.targetDisease!
        .toLowerCase()
        .replaceAll(' ', '_')
        .replaceAll('-', '_'));
  }
  ...
  for (final agData in allAntigenData) {
    ...
    final className = snakeCaseToCamelCase(agData.targetDisease!
        .toLowerCase()
        .replaceAll(' ', '_')
        .replaceAll('-', '_'));
    antigenOutputString.writeln('$className,');
  ...
  antigenOutputString.writeln('};\n');
  File('pythia/lib/generated_files/antigen_supporting_data.dart')
